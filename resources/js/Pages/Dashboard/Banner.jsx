...
export default function Banner({ auth }) {
  ...
  const handlePublish = async () => {
    try {
      ...
      // Publish to database (this will save to DB and make it live)
      ...
      console.log('Hero data published to database:', completeHeroData);
    } catch (err) {
